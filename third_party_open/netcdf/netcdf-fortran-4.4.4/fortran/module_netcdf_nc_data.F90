...
!
! The author grants to the University Corporation for Atmosferic Research
...
! Version 9.:  April 2014 - Changed C_PTRDIFF to UCAR definitions
...
! TS29113 (like gfortran 4.8). Default will be C_INTPTR_T 
 ...
 Integer, Parameter :: C_PTRDIFF = C_INT32_T
#elif (SIZEOF_PTRDIFF_T == 8)
 Integer, Parameter :: C_PTRDIFF = C_INT64_T
#else
 Integer, Parameter :: C_PTRDIFF = C_INTPTR_T
#endif
#endif
