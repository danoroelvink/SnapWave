...
runid='coast3d_v3_g7';
fname=['..\output\snapwave_',runid,'_his.nc'];
s2=sqrt(2);
...
figure(2)
export_fig(['..\results\Coast3D',casename,'_Hm0_timeseries_comparison_',runid,'.png'])
figure(3)
export_fig(['..\results\Coast3D',casename,'_Hm0_scatterplot_',runid,'.png'])

fi=fopen(['..\results\Coast3D',casename,'_stats_Hm0_',runid,'.txt'],'w');
